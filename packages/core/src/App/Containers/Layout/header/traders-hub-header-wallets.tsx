                ...
                {isDesktop ? (
                    <React.Fragment>
                        <div className='traders-hub-header-wallets__logo'>
                            <StaticUrl href='/'>
                                <div style={{ fontSize: '22px', fontWeight: 'bold', background: 'linear-gradient(45deg, #06D6A0, #22C55E)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', letterSpacing: '0.5px' }}>Derihub</div>
                            </StaticUrl>
                        </div>
                    ...
                    <React.Fragment>
                        ...
                        <div className={'traders-hub-header__logo-wrapper'}>
                            <div className='traders-hub-header-wallets__logo'>
                                <StaticUrl href='/'>
                                    <div style={{ fontSize: '22px', fontWeight: 'bold', background: 'linear-gradient(45deg, #06D6A0, #22C55E)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', letterSpacing: '0.5px' }}>DH</div>
                                </StaticUrl>
                            </div>
                        </div>
                    </React.Fragment>
